...
angular.module('itest.portal.myresults.controllers')

    .controller('MyResultsCtrl', function($scope, $location, testService, PagingModel,
                                        $stateParams, categoryService, topicService, $state, previousStateService) {
        var paging = new PagingModel(testService.getTestsMyResults);
