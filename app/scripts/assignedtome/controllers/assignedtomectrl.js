...
angular.module('itest.portal.assignedtome.controllers')

    .controller('AssignedToMeCtrl', function($scope, $location, testService, PagingModel,
                                        $stateParams, categoryService, topicService, $state, previousStateService) {
        var paging = new PagingModel(testService.getTestsAssignedToMe);
        ...
        $scope.sortOptions = {
            ...
            items: [
                {name: 'Дата окончания', value: 'deadline'},
